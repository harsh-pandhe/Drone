...
export default function PreLoader() {
    ...
    useEffect(() => {
        // Always dismiss after 2.5 s — guaranteed fallback
        const timer = setTimeout(() => setVisible(false), 2500);

        // If page is already loaded, dismiss sooner
        ...
        <AnimatePresence>
            {visible && (
                ...
                >
                    ...
                    {/* Drone SVG with spinning blades */}
                    <div className="relative w-[200px] h-[200px] md:w-[260px] md:h-[260px]">
                        ...
                        >
                            {/* Inline style for reliable SVG blade spin */}
                            <style>{`
                                .loader-blade {
